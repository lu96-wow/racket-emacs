...
;;
;; ============================================================================
;; FFI-based terminal I/O.  No internal editor dependencies.
;; ============================================================================
;;
;;   screen-init!         — enter raw mode, start resize monitor
;;   screen-cleanup!      — restore terminal, exit raw mode
;;   terminal-width       — parameter, current terminal width
;;   terminal-height      — parameter, current terminal height
;;   detect-terminal-size! — query ioctl TIOCGWINSZ
;;   terminal?            — is stdin a TTY?
;;   resize-channel       — async channel for resize events
;;
;; ============================================================================
;; Side Effects Only — no computation returned
;; ============================================================================
...
(define (enter-raw-mode!)
  ...
  (set-vmin-vtime! t 0 1)  ;; VMIN=0 VTIME=1: 100ms poll, non-blocking for esc seq
