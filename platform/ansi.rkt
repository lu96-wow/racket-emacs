...
;; Pure format strings.  Zero internal dependencies.
...
(define (ansi-fg-16 n) (format "\e[~am" (vector-ref ansi-16-fg-colors n)))
(define (ansi-bg-16 n) (format "\e[~am" (vector-ref ansi-16-bg-colors n)))
