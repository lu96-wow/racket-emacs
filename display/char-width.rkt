...
;; display/char-width.rkt — Character display width + gap-level column scanning
;;
;; Pure functions.  char-display-width classifies each codepoint,
;; gap-display-width / scan-display-width operate on gap buffers.
