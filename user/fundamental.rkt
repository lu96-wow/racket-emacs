...
(define (init-fundamental-bindings!)
  ...
  (bind-key fundamental-keymap "C-left" backward-word) (bind-key fundamental-keymap "C-right" forward-word)
  (bind-key fundamental-keymap "C-w left" backward-word) (bind-key fundamental-keymap "C-w right" forward-word)
